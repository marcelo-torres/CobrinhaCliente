...
public class Mensageiro implements Closeable {
    ...
    public static class Entregador implements Runnable {
        ...
        protected final InterpretadorCliente INTERPRETADOR;
        protected final Mensageiro MENSAGEIRO;
        
        protected boolean emEexecucao = false;
        
        public Entregador(InterpretadorCliente interpretador, Mensageiro mensageiro) {
    ...
    public Mensageiro(
            InterpretadorCliente interpretador,
            Modo modo,
            int portaEscutarUDP,
